...
const STAGE_LABELS = {
  prep:      { nextLabel: "→ SENT TO CURE",    prevLabel: null,              color: "#3b82f6" },
...
export default function OrderCard({ order }) {
  ...
  const stage = STAGE_LABELS[order.status] || STAGE_LABELS.prep;
  ...
  async function handleRegress() {
    setRegressing(true);
    await regressOrder(order.id, order.status);
    setRegressing(false);
  }
  ...
  return (
    <>
      <div style={styles.card}>
        ...
        {/* Move back button — logged in only */}
        {currentUser && stage.prevLabel && (
          <button
            style={styles.regressBtn}
...
const styles = {
  ...
  accent: { height: "4px", width: "100%", marginBottom: "14px" },
  topRow: {
    display: "flex", justifyContent: "space-between",
    alignItems: "center", padding: "0 14px", marginBottom: "4px",
  },
  invoice: {
    color: "#e86a2f", fontSize: "12px",
    fontFamily: "'Oswald', sans-serif", letterSpacing: "1px", fontWeight: 600,
  },
  customer: {
    color: "#aaa", fontSize: "11px", fontFamily: "'Oswald', sans-serif",
    letterSpacing: "1px", textAlign: "right", flex: 1, marginLeft: "8px",
  },
  itemName: {
    color: "#fff", fontSize: "16px", fontFamily: "'Oswald', sans-serif",
    letterSpacing: "1px", margin: "0 0 12px 0", padding: "0 14px", lineHeight: 1.3,
  },
  specs: {
    display: "grid", gridTemplateColumns: "1fr 1fr",
    gap: "8px", padding: "0 14px", marginBottom: "10px",
  },
  expandedSection: {
    borderTop: "1px solid #222", margin: "0 14px 10px", paddingTop: "10px",
  },
  expandedGrid: {
  ...
  notes: {
    color: "#888", fontSize: "12px", margin: "8px 0 0 0",
    padding: "8px", background: "#141414", borderRadius: "6px",
    fontFamily: "'Inter', sans-serif", lineHeight: 1.4,
  },
  expandBtn: {
    display: "block", width: "calc(100% - 28px)", margin: "0 14px 10px",
    padding: "8px", background: "#141414", border: "1px solid #222",
    borderRadius: "6px", fontSize: "10px", fontFamily: "'Oswald', sans-serif",
    letterSpacing: "2px", color: "#555", cursor: "pointer", textAlign: "center",
  },
  advanceBtn: {
    display: "block", width: "calc(100% - 28px)", margin: "0 14px 8px",
    padding: "12px", background: "transparent", border: "1px solid",
    borderRadius: "8px", fontSize: "12px", fontFamily: "'Oswald', sans-serif",
    letterSpacing: "2px", cursor: "pointer", textAlign: "center", fontWeight: 600,
  },
  regressBtn: {
    display: "block", width: "calc(100% - 28px)", margin: "8px 14px 0",
    padding: "10px", background: "transparent", border: "1px solid #333",
    borderRadius: "8px", fontSize: "11px", fontFamily: "'Oswald', sans-serif",
    letterSpacing: "2px", cursor: "pointer", textAlign: "center", color: "#555",
  },
  completedBadge: {
    display: "block", width: "calc(100% - 28px)", margin: "0 14px",
    padding: "12px", background: "#1a1f2e", border: "1px solid #64748b",
    borderRadius: "8px", fontSize: "12px", fontFamily: "'Oswald', sans-serif",
    letterSpacing: "2px", color: "#64748b", textAlign: "center",
  },
  managerRow: {
  ...
  editBtn: {
    ...
    fontFamily: "'Oswald', sans-serif", cursor: "pointer", padding: "4px 10px",
  },
  deleteBtn: {
    background: "none", border: "none", color: "#333", fontSize: "10px",
    letterSpacing: "1px", fontFamily: "'Oswald', sans-serif", cursor: "pointer",
  },
  confirmText: { color: "#666", fontSize: "11px", fontFamily: "'Inter', sans-serif" },
  confirmYes: {
    background: "#7f1d1d", color: "#ff4444", border: "none", borderRadius: "4px",
    padding: "4px 10px", fontSize: "11px", fontFamily: "'Oswald', sans-serif", cursor: "pointer",
  },
  confirmNo: {
    background: "#1a1a1a", color: "#aaa", border: "1px solid #333", borderRadius: "4px",
    padding: "4px 10px", fontSize: "11px", fontFamily: "'Oswald', sans-serif", cursor: "pointer",
  },
};
